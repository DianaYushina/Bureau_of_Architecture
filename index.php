...
?>
		<div class="first-part">
			<div class="text-style-p1">
				<h1 class="big-text">We build your dream house well and professionally</h1> 
			</div>
			<div class="text_little_style">
				<div class="text_little">Our team can build a house according to your wishes. Any design and concept, we will help make it happen</div>
			</div>
			<div class="button_style_p1">
				<a class="button-a" id="button-form" href="#">Contact us</a>
			</div>
		</div>
		...
		<div class="part2">
			 <div class="page2-style">
			 	<div>
			 		<img class="photo1"src="media/img/Rectangle 31.jpg">
			 		<img class="photo2"src="media/img/Rectangle 32.jpg">
			 	</div>
		...
		<div class="page3">
			...
			<div>
				<img class="photo-page3" src="media/img/ryan-ancill-Vew4xyLkpdY-unsplash 1.jpg">
			</div>
		</div>
		...
		<div class="page4">
			<div class="p4-style">
				<div class="photo-style-p4">
					<div class="pho-p4">
						<div>
							<img src="media/img/Rectangle 5.jpg">
						</div>
						<div>
							<img src="media/img/Rectangle 8.jpg">
						</div>
					</div>
					<div class="pho-p4">
						<div>
							<img src="media/img/Rectangle 6.jpg">
						</div>
						<div>
							<img src="media/img/Rectangle 7.jpg">
						</div>
					</div>
					<div class="log_p4">
						<img src="media/img/log.png" width="168px;">
					</div>
				</div>
		...
		<div class="page5">
			...
			<div class="video-p5">
				...
				<div>
					<img class="photo_on-video" src="media/img/vid.png" width="250">
				</div>
			</div>
		</div>
		...
		<div class="page-7">
			<div class="style-p7">
				<div class="sub-style-p7">
					<div>
						<img class="main-ph-7" src="media/img/Rectangle 13.jpg">
					</div>
					<div class="text-p7-h">Design building/house</div>
					<div class="text2-p7-h">We have an architect for design new buildings</div>
					<div>
						<img class="ph-p7-1" src="media/img/Vector.png">
					</div>
				</div>
				
				 <div class="sub-style-p7">
					<div>
						<img class="main-ph-7" src="media/img/Rectangle blue 13.png">
					</div>
					...
					<div>
						<img class="ph-p7-2" src="media/img/Vector (1).png">
					</div>
				</div>
				...
				<div class="sub-style-p7">
					...
					<div>
						<img class="ph-p7-3" src="media/img/Vector (2).png">
					</div>
				</div>
				...
				<div class="sub-style-p7">
					...
					<div>
						<img class="ph-p7-4" src="media/img/Vector (3).png">
					</div>
				</div> 
			</div>
		</div>
		...
		<div class="page-8">
			...
			<div class="photo-style-p8-1">
				...
				<div class="photo-p8">
					<img src="media/img/Rectangle 14.jpg"/>
				</div>
				<div class="photo-p8">
					<img src="media/img/Rectangle 19.jpg"/>
				</div>
				<div class="photo-p8">
					<img src="media/img/Rectangle 20.jpg" />
				</div>
			</div>

			
				<div class="pos-photo-p8">
					<img class="photo-p8" src="media/img/Rectangle 22.jpg"/>
				</div>


			<div class="photo-style-p8-2">
				<div>
					<img class="photo-p8-1-1" src="media/img/Rectangle 18.jpg"/>
				</div>
				<div>
					<img class="photo-p8-2-2" src="media/img/Rectangle 17 (1).jpg" />
				</div>
				<div>
					<img class="photo-p8-3-3" src="media/img/Rectangle 21.jpg"/>
				</div>
			</div> 
			...
			<div class="photo_with_man_p8">
				<img src="media/img/man.png" width="450px" />
			</div>
		</div>
